...
All persons involved in the project are researchers (diabetes
epidemiologists)
...
fra familie- og tidlige livsdeterminanter til udvikling, håndtering og
pleje af diabetes og de sygdomme, der kan opstå efter en
diabetesdiagnose, under en livsforløbsramme.

Diabetes er en kompleks, multifaktoriel sygdom. Dets udvikling afhænger
af timingen og akkumuleringen af eksponeringer gennem hele livsforløbet.
Ud over genetiske påvirkninger samler adfærdsmæssige risikofaktorer og
socioøkonomiske forhold sig i familier og går gennem generationer. For
eksempel kan dårlig socioøkonomisk status (SØS) i barndommen påvirke den
endelige uddannelsesniveau, voksen-SØS og livsstils- og
adfærdskarakteristika, som i sidste ende påvirker et individs
metaboliske kapacitet til at regulere glukose og efterfølgende risiko
for diabetes.

Dette projekt vil bidrage til en bredere og dybere forståelse af den
rolle, som disse faktorer spiller for udvikling og progression af
...
de integrerede datakilder med et overordnet mål til at modellere
adskillige potentielle folkesundhedsstrategier, der kan påvirke
...
Alle personer involveret i projektet er forskere (diabetes
epidemiologer)
...
Mere information om vores proces fra enten Annelli Sandbæk, Adam Hulman,
or Else-Marie Dalsgaard.
