...
41. Archived Git repository and submitted report on:
...
52. Archived Git repository and submitted report on objective 3

### Milestones

### Timeline

```{r gantt-chart, echo=FALSE, fig.width=9}
library(readr)
library(dplyr)
source(here::here("R/gantt.R"))
tasks_d1 <- read_csv(here::here("resources/tasks.csv"),
         col_types = cols_only(
             deliverable = "c",
             task_name = "c",
             priority = "c",
    ...
    filter(deliverable == "D1")

build_gantt(tasks_d1, "deliverable")
```
