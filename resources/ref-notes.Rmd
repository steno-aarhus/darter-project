...
## Danish Civil Registration System (CRS) (by Pedersen)

doi:10.1177/1403494810387965

- For civil status variable, spouse ID is also included

- Pretty similar to one above.
...
- PER = Registret over befolkningens uddannelse (BU)
...
## Intro to health registers (Thygesen)

doi:10.1177/1403494811399956

- Has a nice Table 1 and 2
    - Useful health registers:
        - Register of Cause of Death
        - National Patient Register
        - National Health Service Register
        - National Prescription Register
        - National Diabetes Register
    - Useful population registers:
        - Student Register
        - Population's Education Register
        - Integrated Database for Labour Market Research
        - Income Statistics Register
        - Building and Housing Register
- Health data at datatilsynet.dk?        

## National Diabetes Register (Carstensen)

doi:10.1177/1403494811404278

- Established in 2006 based on CRS, Patient Register, National Health Services
Register, and Prescription Register
- Inclusion:
    - From NPR: Diagnosis as defined by ICD-10: DE10–14, DH36.0, DO24(excluding
    DO24.4), and ICD-8 (prior to 1994):249, 250
    - From NHSR: Any of chiropody (as diabetes patient), five blood glucose
    measurements in 1 year, two blood glucose measurements per year in 5
    consecutive years
    - From Prescription: Purchase of oral anti-diabetic drugs (except for
    metformin alone for women, since that is also for PCOS), or prescribed insulin
- Date of inclusion into NDR:
    - NPR: earliest date of diagnosis
    - Chiro: Earliest date
    - 5-glucose: Date of fifth measurement in one year
    - 2-glucose: Date of second measurement in one year, given last 4 years also
    had 2 measures/year
    - Drug: Date of second purchase
    - Insulin: Date of second purchase
- Variables include:
    - CPR, sex, date of birth, date of death, date of inclusion, and six dates above
- Not possible to distinguish between type 1 and 2
- PPV based on the inclusion criterion range from 86-97%

## Danish registers on income and transfer payments

doi:10.1177/1403494811405098

- Danish: Indkomstregistret
- Income Statistics Register contains up to 160 variables
    - e.g. wages, entrepeneurial income, taxes, capital income,
    home ownership, SES, age, sex, family
- Contains info on benefits during sick leave or from pregnancy/parental leave
- Register of Social Pension contains data on anyone receiving disability pensions
...
# From Danish Health Data

https://www.danishhealthdata.com/find-health-data

Application process:

- Applying for it need a project description and an extension description must
be attached, containing information about which registries, variables,
population and period that are applied for.
...
https://www.danishhealthdata.com/find-health-data/Det-Medicinske-foedselsregister

In Danish: Det Medicinske fødselsregister (MFR)

- Data on all live and dead births since 1973
- Before 1996, registry was based on paper certificates
    - Afterward based on data from National Patient Register and CPR register
    (plus paper reports on home births)
- Variables:
    - Birth weight, Child's CPR No., Child's gender, Child's head measurement at
    birth, Civil status of parents, Complications, Father's CPR No., Home birth,
    Intervention pre/post birth, Labour - duration, Live/dead birth,
    Malformations, Mother's CPR No., Multiple birth, Municipality of residence,
    Pregnancy - length, Smoking
    
## The Central Person Registry

https://www.danishhealthdata.com/find-health-data/CPR-registeret

- Since 1968
- Connects all other registers
- Variables:
    - Address data, Birth registration place, Citizenship, Civil status, CPR
    No., First name(s), Guardianship data, National church - details,
    Relationship
...
In Danish and abbreviation: Dødsårsagsregisteret (DAR)

- Since 1970
- Variables since 2002 differ
- Since Jan 2007, mandatory to submit electronic death certificate
...
Danish: Landspatientregistret (LPR)

- Since 1976

## Conscription Registry

https://www.danishhealthdata.com/find-health-data/Sessionsregisteret

Danish: Sessionsregisteret (SER)

- Controlled by National Danish Archives
- From 1987
- Authorities submit data to Archives every 5 years. Last was 2015
- The population includes all drafted conscripts, meaning all Danish males
living or residing in Denmark who are required to attend a call-up session in
the year they reach 18

## Danish Psychiatric Central Research Register

https://www.danishhealthdata.com/find-health-data/Det-Psykiatriske-Centrale-Forskningsregister

Danish: Det Psykiatriske Centrale Forskningsregister (PCR)

- Since 1969 for psychiatric admissions
- Since 1995 for data on outpatient contacts and accident and emergency visits
- Since 1995 has been part of NPR
