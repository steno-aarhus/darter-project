...
The **overarching aim** of the MELD project is to better quantify and understand the
...
Based on the research questions, the MELD project seeks to address these objectives:
...
- Exposure variables: Parental socio-economic variables from individual's
approximate conception to ~7 years of age

- Outcome variables: Age at T2D status (incidence of T2D)

- Metabolic variables (for pathway analyses): Standard metabolic variables; -omic variables

- Confounding variables: We'll take various approaches to identifying confounding variables...

TODO: Complete confounding
...
knitr::include_graphics("images/lexis-diagram.pdf", dpi = "retina")
```
...
- Building and Housing register? for the social housing etc?
