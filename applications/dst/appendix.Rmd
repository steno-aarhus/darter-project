...
format_non_dst_appendix_table <- function(data, caption = NULL, width = 2.25) {
    data %>%
        flextable::flextable() %>%
...
here("data/atc-codes.csv") %>%
    ...
    format_non_dst_appendix_table(caption = "Requested ATC codes in classifying diabetes and cardiovascular diseases.", width = c(2, 5))
```
